  ...
  def register(self, app: FastAPI) -> None:
    ...
    if "pubsub" in self._trigger_sources:
      ...
      async def trigger_pubsub(
        ...
        if req.message.data:
          try:
            message_text = base64.b64decode(req.message.data).decode("utf-8")
          except Exception as e:
          ...
          message_text = json.dumps(req.message.attributes or {})
